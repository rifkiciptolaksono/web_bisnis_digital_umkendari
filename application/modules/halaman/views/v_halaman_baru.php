					...
					<div class="col-lg_12" style="padding:0 10px;">
						...
						<div class="form-group">
				            <div class='input-group date' id='datetimepicker'>
				                <input value="<?php if(@$halaman['tgl_tulisan']){echo $halaman['tgl_tulisan'];}else{echo date('Y-m-d h:i');}?>" name="tgl_halaman" type='text' class="form-control" data-uk-datepicker="{format:'YYYY-MM-DD h:mm'}"/>
