...
<head>
    ...
    <title><?php if(isset($site['web']['blogname'])){echo$site['web']['blogname'];}else{echo'title';}?> | <?php if(isset($site['page'])){echo$site['page'];}else{echo'page';}?></title>
                        ...
                        <li data-uk-dropdown="{mode:'click'}">
                            ...
                            <div class="uk-dropdown uk-dropdown-small uk-dropdown-flip">
                                <ul class="uk-nav js-uk-prevent">
                                    ...
                                    <li><a href="<?php echo site_url('login/logout');?>"><i class="fa fa-power-off"></i> Keluar</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
...
<div id="style_switcher">
    ...
    <div class="uk-visible-large">
        ...
        <p>
            <input type="checkbox" name="status_website" id="status_website" data-md-icheck <?php if(@$sts[0]['option_value']&&$sts[0]['option_value']!=null&&$sts[0]['option_value']=='off'){echo'checked';}?> />
