...
<div class="row">
		...
		<div class="col-lg-9">
			...
			<div id="peta-panel" style="display:none;">
				<input type="hidden" name="latitude" id="latitude" class="form-control" value="<?php if(isset($tulisan['latitude'])){echo $tulisan['latitude'];$latitude=$tulisan['latitude'];}else{$latitude='';}?>">
				<input type="hidden" name="longitude" id="longitude" class="form-control" value="<?php if(isset($tulisan['longitude'])){echo $tulisan['longitude'];$longitude=$tulisan['longitude'];}else{$longitude='';}?>">
				<div class="form-group">
		...
		<div class="col-lg-3">
						...
						<div class="col-lg_12" style="padding:0 10px;">
							...
							<div class="form-group">
					            <div class='input-group date' id='datetimepicker'>
					                <input value="<?php if(@$tulisan['tgl_tulisan']){echo $tulisan['tgl_tulisan'];}else{echo date('Y-m-d h:i');}?>" name="tgl_tulisan" type='text' class="form-control" data-uk-datepicker="{format:'YYYY-MM-DD h:mm'}"/>
			...
			<div class="panel panel-default square-btn-adjust">
				...
				<div class="panel-body">
					...
					<div id="form-tambah-kategori-field" style="display:none">
						...
						<div class="form-group">
							<button id="btn-tambah-kategori" type="button" class="btn btn-sm btn-default square-btn-adjust" title="Tambah kategori baru"><li class="fa fa-plus"></li> Tambah kategori baru</button>
						</div>
					</div>
				</div>
			</div>
			<div class="panel panel-default square-btn-adjust">
				...
				<div class="panel-footer text-right">
					<button id="btn-terbitkan-halaman" type="submit" class="btn btn-primary square-btn-adjust" style="padding:5px 7px;"><li class="fa fa-check"></li> Simpan</button>
				</div>
			</div>
				...
				<div class="panel-body">
					<div class="form-group">
			            ...
			            <div class='input-group date' id='datetimepicker2'>
			                <input value="<?php if(@$halaman['tgl_mulai']){echo $halaman['tgl_mulai'];}else{echo date('Y-m-d h:i');}?>" name="tgl_mulai" type='text' class="form-control" data-uk-datepicker="{format:'YYYY-MM-DD h:mm'}"/>
			                <span class="input-group-addon">
			                    <span class="glyphicon glyphicon-calendar">
			                    </span>
			                </span>
					...
					<div class="form-group">
						...
						<div class='input-group date' id='datetimepicker3'>
			                <input value="<?php if(@$halaman['tgl_selesai']){echo $halaman['tgl_selesai'];}else{echo date('Y-m-d h:i');}?>" name="tgl_selesai" type='text' class="form-control" data-uk-datepicker="{format:'YYYY-MM-DD h:mm'}"/>
			                <span class="input-group-addon">
			                    <span class="glyphicon glyphicon-calendar">
			                    </span>
			                </span>
...
function lihat_peta(){
	...
	google.maps.event.addListener(searchBox, 'places_changed', function() {
		...
		zoomChangeBoundsListener = google.maps.event.addListenerOnce(map, 'bounds_changed', function(event) {
			if (this.getZoom()){this.setZoom(15);}
		});
	});
